...
class EmergencyHandler implements UncaughtExceptionHandler {
    ...
    void processException(final Throwable th) {
        try {
            ...
            final String name = EBookDroid.APP_PACKAGE + "." + EBookDroid.APP_VERSION_NAME + "." + timestamp
                    + ".stacktrace";
    ...
    private void writeToFile(final String stacktrace, final File filename) {
        try {
            ...
            bos.write("This file was generated by the " + EBookDroid.APP_PACKAGE + "."
                    + EBookDroid.APP_VERSION_NAME + "(" + EBookDroid.APP_VERSION_CODE + ")\n");
            bos.write("\nDevice information:\n\n");
            bos.write("VERSION     : " + AndroidVersion.VERSION + "\n");
            bos.write("BOARD       : " + Build.BOARD + "\n");
            bos.write("BRAND       : " + Build.BRAND + "\n");
            bos.write("CPU_ABI     : " + EBookDroid.BUILD_PROPS.getProperty("ro.product.cpu.abi") + "\n");
            bos.write("CPU_ABI2    : " + EBookDroid.BUILD_PROPS.getProperty("ro.product.cpu.abi2") + "\n");
            bos.write("DEVICE      : " + Build.DEVICE + "\n");
            bos.write("DISPLAY     : " + Build.DISPLAY + "\n");
            bos.write("FINGERPRINT : " + Build.FINGERPRINT + "\n");
            bos.write("ID          : " + Build.ID + "\n");
            bos.write("MANUFACTURER: " + EBookDroid.BUILD_PROPS.getProperty("ro.product.manufacturer") + "\n");
